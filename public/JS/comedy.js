...
const movieData = {
    montyPython: {
        ...
        cast: [
            { name: "Graham Chapman", role: "King Arthur", img: "/assets/comedy/Graham_Chapman.jpg" },
            { name: "John Cleese", role: "Sir Lancelot the Brave", img: "/assets/comedy/John_Cleese.jpg" },
        ]
    },
    airplane: {
        title: "Airplane! (1980)",
    ...
    americanPie: {
        ...
        cast: [
            { name: "Jason Biggs", role: "Jim Levenstein", img: "/assets/comedy/Jason_Biggs.jpg" },
            { name: "Chris Klein", role: "Chris 'Oz' Ostreicher", img: "/assets/comedy/Chris_Klein.jpg" },
        ]
    },
    superbad: {
        title: "Superbad (2007)",
        ...
        cast: [
            { name: "Jonah Hill", role: "Seth", img: "/assets/comedy/Jonah_Hill.jpg" },
            { name: "Michael Cera", role: "Evan", img: "/assets/comedy/Michael_Cera.jpg" },
        ]
    },
    friends: {
        ...
        cast: [
            { name: "Jennifer Aniston", role: "Rachel Green", img: "/assets/comedy/Jennifer_Aniston.jpg" },
            { name: "Courteney Cox", role: "Monica Geller", img: "/assets/comedy/Courteney_Cox.jpg" },
        ]
    },
    theOffice: {
        ...
        cast: [
            { name: "Steve Carell", role: "Michael Scott", img: "/assets/comedy/Steve_Carell.jpg" },
            { name: "Rainn Wilson", role: "Dwight Schrute", img: "/assets/comedy/Rainn_Wilson.jpg" },
        ]
    },
    parksAndRec: {
    ...
    brooklynNineNine: {
        ...
        cast: [
            { name: "Andy Samberg", role: "Jake Peralta", img: "/assets/comedy/Andy_Samberg.jpg" },
            { name: "Terry Crews", role: "Terry Jeffords", img: "/assets/comedy/Terry_Crews.jpg" },
        ]
    },
    schittsCreek: {
        ...
        cast: [
            { name: "Eugene Levy", role: "Johnny Rose", img: "/assets/comedy/Eugene_Levy.jpg" },
            { name: "Catherine O'Hara", role: "Moira Rose", img: "/assets/comedy/Catherine_OHara.jpg" },
        ]
    },
};

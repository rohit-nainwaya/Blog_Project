const movieData = {
    toyStory: {
        ...
        cast: [
            { name: "Tom Hanks", role: "Woody (voice)", img: "/assets/animation/tom_hanks.jpg" },
            { name: "Tim Allen", role: "Buzz Lightyear (voice)", img: "/assets/animation/tim_allen.jpg" },
        ]
    },
    spiritedAway: {
        ...
        cast: [
            { name: "Rumi Hiiragi", role: "Chihiro (voice)", img: "/assets/animation/rumi_hiiragi.jpg" },
            { name: "Miyu Irino", role: "Haku (voice)", img: "/assets/animation/miyu_irino.jpg" },
        ]
    },
    theLionKing: {
        ...
        cast: [
            { name: "Matthew Broderick", role: "Simba (voice)", img: "/assets/animation/matthew_broderick.jpg" },
            { name: "Jeremy Irons", role: "Scar (voice)", img: "/assets/animation/jeremy_irons.jpg" },
        ]
    },
    findingNemo: {
        ...
        cast: [
            { name: "Albert Brooks", role: "Marlin (voice)", img: "/assets/animation/albert_brooks.jpg" },
            { name: "Ellen DeGeneres", role: "Dory (voice)", img: "/assets/animation/ellen_degeneres.jpg" },
        ]
    },
    shrek: {
        title: "Shrek (2001)",
        ...
        cast: [
            { name: "Mike Myers", role: "Shrek (voice)", img: "/assets/animation/mike_myers.jpg" },
            { name: "Eddie Murphy", role: "Donkey (voice)", img: "/assets/animation/eddie_murphy.jpg" },
        ]
    },
    frozen: {
        title: "Frozen (2013)",
        ...
        cast: [
            { name: "Idina Menzel", role: "Elsa (voice)", img: "/assets/animation/idina_menzel.jpg" },
            { name: "Kristen Bell", role: "Anna (voice)", img: "/assets/animation/kristen_bell.jpg" },
        ]
    },
    up: {
        title: "Up (2009)",
        ...
        cast: [
            { name: "Ed Asner", role: "Carl Fredricksen (voice)", img: "/assets/animation/ed_asner.jpg" },
            { name: "Jordan Nagai", role: "Russell (voice)", img: "/assets/animation/jordan_nagai.jpg" },
        ]
    },
    spiderVerse: {
        ...
        cast: [
            { name: "Shameik Moore", role: "Miles Morales / Spider-Man (voice)", img: "/assets/animation/shameik_moore.jpg" },
            { name: "Jake Johnson", role: "Peter B. Parker / Spider-Man (voice)", img: "/assets/animation/jake_johnson.jpg" },
        ]
    },
    insideOut: {
        ...
        cast: [
            { name: "Amy Poehler", role: "Joy (voice)", img: "/assets/animation/amy_poehler.jpg" },
            { name: "Phyllis Smith", role: "Sadness (voice)", img: "/assets/animation/phyllis_smith.jpg" },
        ]
    },
    yourName: {
        ...
        cast: [
            { name: "Ryunosuke Kamiki", role: "Taki Tachibana (voice)", img: "/assets/animation/ryunosuke_kamiki.jpg" },
            { name: "Mone Kamishiraishi", role: "Mitsuha Miyamizu (voice)", img: "/assets/animation/mone_kamishiraishi.jpg" },
        ]
    }
};
